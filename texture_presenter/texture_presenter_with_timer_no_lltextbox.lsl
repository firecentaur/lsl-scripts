// LSL script generated: texture_presenter_with_timer_no_lltextbox.lslp Mon Mar 18 01:29:41 Tokyo Standard Time 2013
/*
*
...
default {
    ...
    state_entry() {
        llSetText("",RED,1);
        (MENU_CHANNEL = random_integer(((-900000) - 30),0));
        (TEXT_BOX_CHANNEL = 9);
